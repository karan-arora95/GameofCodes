			...
			<div class="contact_top">			 		
			 <div class="col-md-8 contact_left">
					...
					<form action="logindb.jsp">
					  <div class="form_details">
					      USERNAME:</br> <input type="text" class="text" name="username" value="UserName" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Name';}"> </br></br></br>
					      PASSWORD: </br> <input type="text" class="text" name="password" value="Password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Subject';}"> </br></br> </br>
			 ...
			 <div class="col-md-4 company-right">
				 <div class="company_ad">
			      	 ...
			      	 <address>
						 <p>email : <a href="delhi.karanarora@gmail.com">info@display.com</a></p>
...
<div class="copywrite">
	 <div class="container">
		 <p>Copyright © 2015 University. All rights reserved | Design by <a href="http://w3layouts.com">KaranArora</a></p>
	 </div>
</div>
<!---->
</body>
